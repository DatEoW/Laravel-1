    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">DatNews <sup>PS19726</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTrash"
                aria-expanded="true" aria-controls="collapseTrash">
                <i class="fa fa-trash"></i>
                <span>Thùng Rác</span>
            </a>
                <div id="collapseTrash" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">

                        <a class="collapse-item" href="{{ url('/admin/thungrac') }}">Loại Tin</a>
                        <a class="collapse-item" href="{{ url('/admin/thungracu') }}">Người Dùng</a>
                    </div>
                </div>
            </li>
